  ...
  return (
    <div>
      <div>
        ...
        <div className=" flex justify-between gap-16 ">
          ...
          <div className="">
            ...
            <p className=" text-sm">
              ...
              . Please mind that we are still in the stages of developing the
              details, so what you see here are indicators that are subject to
              change. We will announce the finalized agenda via our social
              channels in 2025.
            </p>
        ...
        <button className=" bg-secondary border border-black/40 text-main py-3 px-36 rounded-xl  ">
        Edit Details
          </button>
